...
import {
  ...
  CheckCircle, BarChart3, Shield, Play,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-6xl px-4 lg:px-6 pt-20 pb-16 text-center">
        <Badge variant="secondary" className="mb-6 gap-1.5">
          ...
          Cumple con el RD 214/2025 y la normativa VSME
        </Badge>
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
          SENDA es la plataforma de sostenibilidad para PYMEs españolas.
          Autodiagnóstico ASG, huella de carbono automatizada, informes VSME
          y asistente IA — sin consultoras, sin complejidad.
        </p>
        ...
        <p className="mt-4 text-xs text-muted-foreground">
          Sin tarjeta de crédito · Gratis 30 días · Open source (AGPL-3.0)
        </p>
      </section>
      ...
      <section id="demo" className="bg-muted/40 py-16">
        <div className="mx-auto max-w-4xl px-4 lg:px-6 text-center">
          <h2 className="text-2xl font-bold mb-3">Descubre SENDA en 2 minutos</h2>
          <p className="text-muted-foreground mb-8">
            Mira cómo pasar del autodiagnóstico al informe VSME en menos de una semana.
          </p>
          <div className="relative mx-auto aspect-video max-w-3xl rounded-xl bg-muted border border-border flex items-center justify-center overflow-hidden">
            ...
            {[
              {
                icon: AlertTriangle,
                stat: "83%",
                label: "de las PYMEs no están preparadas para la normativa ESG que entra en vigor",
                color: "text-destructive",
              },
              {
                icon: FileWarning,
                stat: "5.000€",
                label: "es el coste medio de un informe ESG externo que te ahorras con SENDA",
                color: "text-accent",
              },
              {
                icon: TrendingDown,
                stat: "RD 214/2025",
                label: "establece la obligación de reporte ESG para empresas con +250 empleados desde 2027",
                color: "text-secondary",
              },
            ].map((item) => {
              const Icon = item.icon;
              return (
                <Card key={item.stat} className="p-6 text-center hover:shadow-md transition-shadow">
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Una plataforma completa, sin consultoras, sin complejidad.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                icon: FileText,
                title: "Informes VSME",
                desc: "Genera informes conformes con el estándar VSME con un solo clic.",
      ...
      <section id="how-it-works" className="py-16">
        <div className="mx-auto max-w-4xl px-4 lg:px-6 text-center">
          ...
          <p className="text-muted-foreground mb-12">
            De cero a informe ESG en menos de una semana.
          </p>
            ...
            {[
              {
                ...
                price: "0€",
                period: "/mes",
                desc: "Para empezar tu senda",
                features: [
                  "1 diagnóstico ASG",
                  "Huella carbono básica",
                  "1 informe VSME/mes",
                  "Asistente IA (5 consultas)",
                ],
                cta: "Empezar gratis",
                href: "/register",
                highlight: false,
      ...
      <section className="bg-primary py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-3xl font-bold text-primary-foreground mb-4">
            Prepárate para el RD 214/2025 antes que tu competencia
          </h2>
          <p className="text-primary-foreground/80 mb-8">
            Únete a las PYMEs que ya están recorriendo su senda hacia la sostenibilidad con SENDA.
          </p>
          <Link
            href="/register"
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">SENDA</span>
            </div>
            <p className="text-sm text-muted-foreground">
              © 2026 SENDA — Open source bajo{" "}
